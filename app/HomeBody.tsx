  ...
  return (
    <section className="section bg-ivory">
      <div className="container">
        ...
        {cities.length + COMING_SOON_CITIES.length === 0 ? (
          <p className="body muted" style={{ maxWidth: 520 }}>
            {PAGES.home.cities.emptyMessage}
          </p>
        ) : (
          <div
      ...
      <div className="container">
        ...
        >
          <div style={{ aspectRatio: '4 / 5', overflow: 'hidden' }} data-reveal="mask">
            <SmartImage
              src={PAGES.home.story.image || IMAGES.detail_brick}
              alt={PAGES.home.story.imageAlt}
