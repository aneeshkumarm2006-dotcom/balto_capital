...
/* BALTO CMS — Dashboard: portfolio stats and an at-a-glance building table. */
...
interface Building {
  slug: string;
  name: string;
  city: 'saskatoon' | 'edmonton' | 'regina' | 'yellowknife';
  address: string;
  featured?: boolean;
}
...
const CITY_LABELS: Record<Building['city'], string> = {
  saskatoon: 'Saskatoon',
  edmonton: 'Edmonton',
  regina: 'Regina',
            ...
            {buildings.map((b) => {
              ...
              return (
                ...
                >
                  ...
                  <td>{CITY_LABELS[b.city] ?? b.city}</td>
