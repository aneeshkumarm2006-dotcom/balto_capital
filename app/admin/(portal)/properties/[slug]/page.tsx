...
/* BALTO CMS — Property details editor: listing info, "close to" chips,
...
export default function PropertyDetailsPage() {
  ...
  const [linksAll, setLinksAll] = useState<LinksData>({ applyLinks: {}, zenSlugs: {} });
    ...
    Promise.all([
      ...
      .then(([b, c, a, l, tax, cities, geocoded]) => {
        ...
        const links: LinksData = {
          applyLinks:
            l && typeof l.applyLinks === 'object' && l.applyLinks !== null
              ...
              : {},
          zenSlugs:
            l && typeof l.zenSlugs === 'object' && l.zenSlugs !== null
              ? l.zenSlugs
              : {},
        };
        ...
        const initial: Draft = {
          ...
          zenSlug: typeof links.zenSlugs[slug] === 'string' ? links.zenSlugs[slug] : '',
          apply,
        };
        setDraft(initial);
  ...
  const handleSave = async () => {
    ...
    try {
      ...
      const nextZenSlugs = { ...linksAll.zenSlugs };
      const zen = draft.zenSlug.trim();
      if (zen) nextZenSlugs[slug] = zen;
      else delete nextZenSlugs[slug];
      const nextLinks: LinksData = { applyLinks: nextApplyLinks, zenSlugs: nextZenSlugs };
  ...
  const handleDelete = async () => {
    ...
    try {
      ...
      await putContent('copy', nextCopy);
      await putContent('amenities', nextAmenities);
      await putContent('links', { applyLinks: nextApplyLinks, zenSlugs: nextZenSlugs });
    ...
    <>
      ...
      <section className="adm-card" style={{ marginBottom: 22 }}>
        ...
        <div className="adm-card-pad">
          ...
          <ChipEditor
            ...
            placeholder="e.g. Metro Line LRT"
      ...
      <section className="adm-card" style={{ marginBottom: 22 }}>
        ...
        <div className="adm-card-pad">
          <div className="adm-form-grid">
            <Field
              label="ZenRentals property slug"
              span2
            ...
            >
              <input
                className="adm-input"
                value={draft.zenSlug}
                onChange={(e) => patch({ zenSlug: e.target.value })}
              />
            </Field>
            {BED_KEYS.map((k) => (
