    ...
    sections: [
      {
        ...
        list: {
          ...
          help: 'The header links, in order. "Company" is a dropdown holding "About", "Why Balto" and "Team", so those three are edited here but shown inside it. Each entry has its own layout, so items cannot be added or removed here — only reworded or repointed.',
          fields: [
